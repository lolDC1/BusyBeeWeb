...
export interface QueryDataProvider<TListResponse, TQuery extends ApiQueryParameters> {
...
export interface CacheableAutocompleteDataProvider<TAutocomplete = ListItem> extends AutocompleteDataProvider<TAutocomplete> {
  data: TAutocomplete[] | undefined;
  isLoaded: boolean;
}

export interface CrudDataProvider<TPrimaryKey, TCreateCommandDto, TUpdateCommandDto, TDetailedResponse>
...
export interface UpdateDataProvider<TPrimaryKey, TUpdateCommandDto, TDetailedResponse> {
  update(id: TPrimaryKey, command: TUpdateCommandDto): Observable<TDetailedResponse>;
}
