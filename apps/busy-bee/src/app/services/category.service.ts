...
export class CategoryService extends EntityApiDataProvider<
  CategoryModel,
  CategoryModel,
  CategoryModel,
  CategoryModel,
...
> {
  ...
  getTemplate(categoryId: string): Observable<CategoryDataTemplatesModel> {
    return this.httpClient.get<CategoryDataTemplatesModel>(
      `${this.baseEntityUrl}/${categoryId}/datatemplates`
    );
  }
